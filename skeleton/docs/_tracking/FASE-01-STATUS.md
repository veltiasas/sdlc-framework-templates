...
- [ ] 2.4 User stories descriptivas (10-12, sin MoSCoW formal)
...
- [ ] 5.1 Verificación: gate intermedio ✅
...
- [ ] 7.3 Git configurado (.gitignore, commitlint, README)
...
- [ ] No hay features MVP sin user story
- [ ] No hay user stories MUST sin feature MVP
- [ ] Alguien externo puede leer los docs y entender qué construir
