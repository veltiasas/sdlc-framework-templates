...
- [ ] 4.5 docs/PROPUESTA-CLIENTE.md generado (versión actual)
- [ ] 4.6 Versión snapshot en docs/_propuestas/propuesta-v[N].md
- [ ] 4.7 Context dump → _session-notes/session-04.md
- Estado sesión: ⬜ Pendiente
...
Claude hace preguntas guiadoras para entender el problema completo, sintetiza un problem statement en 1 oración, arma un análisis competitivo desde el ángulo del problema (qué resuelven mal las alternativas actuales), propone 3-5 KPIs candidatos sin umbrales, documenta el proceso actual con actores, y genera `docs/PROBLEM-STATEMENT.md`.
...
Basándote en el problema, las personas, las restricciones y el análisis
de cómo lo resolvieron otros, proponé 2-3 enfoques GENUINAMENTE DISTINTOS.
...
1. Si es v1: creá docs/PROPUESTA-CLIENTE.md con el contenido final.
...
7.  /s1-relevamiento
8.  [Responder preguntas, iterar]
9.  [Claude genera PROBLEM-STATEMENT.md]
10. /clear
...
12. /s2-personas
13. [Responder, iterar]
14. [Claude genera PERSONAS.md sin priorización formal]
15. /clear
...
16. Shift+Tab x2
17. /s3-opciones
18. [Responder sobre restricciones y preferencias]
19. [Claude propone 2-3 opciones, trade-offs, recomendación con plan B]
20. [Claude genera OPCIONES-SOLUCION.md]
21. /clear
...
22. Shift+Tab x2
23. /s4-propuesta
24. [Responder sobre modalidad: recomendación o opciones abiertas]
25. [Claude genera PROPUESTA-CLIENTE.md v1]
26. /clear


⭐ GATE INTERMEDIO — Aprobación del cliente
───────────────────────────────────────
27. Presentar PROPUESTA-CLIENTE.md al cliente
28. [Cliente revisa y responde]

CASO A: Cliente aprueba sin cambios
  29a. /cliente-aprobo
  30a. [Command registra aprobación, actualiza tracker, commit]
  31a. Ir al paso 38

CASO B: Cliente pide cambios menores
  29b. /s4-propuesta                  ← command detecta iteración
  30b. [Responder con feedback del cliente]
  31b. [Claude genera PROPUESTA-CLIENTE.md v2, archiva v1 en _propuestas/]
  32b. Volver al paso 27 (nueva ronda con cliente)

CASO C: Cliente rechaza el enfoque (cambio mayor)
  29c. /s3-opciones                   ← volver a replantear opciones
  30c. [Nueva iteración con feedback del cliente]
  31c. Continuar desde paso 22 con las opciones revisadas


SESIÓN 5 — PRD, MoSCoW, KPIs finales (post-aprobación)
───────────────────────────────────────
38. Shift+Tab x2
39. /s5-prd                       ← verifica gate intermedio
40. [Responder, iterar, aprobar MoSCoW y KPIs]
41. [Claude genera PRD.md y MVP-SCOPE.md]
42. /clear
...
43. Shift+Tab x2
44. /s6-arquitectura
45. [Responder, iterar, aprobar]
46. [Claude genera ARCHITECTURE-VISION.md]
47. /clear


SESIÓN 7 — Configuración
───────────────────────────────────────
48. Shift+Tab x1                 ← Normal Mode
49. /s7-config
50. [Claude genera CLAUDE.md definitivo, estructura, Git, commit]
51. NO hacer /clear todavía


CIERRE
───────────────────────────────────────
52. /gate-check
53. [Si TODO pasa → commit automático, Fase 01 cerrada]
    [Si falta algo → lista de correcciones]
54. /clear                       ← Listo para Fase 02
```
